#!/bin/bash
# Marmot v2.9.14-beta - 2-Node Cluster with Read-Only Replicas
#
# Topology:
...
echo "=== Marmot v2.9.14-beta Cluster with Replicas ==="
...
generate_node_config() {
    ...
    cat > "$config_file" << EOF
# Marmot v2.9.14-beta - Node ${node_id} (auto-generated)
node_id = ${node_id}
...
generate_replica_config() {
    ...
    cat > "$config_file" << EOF
# Marmot v2.9.14-beta - Replica ${replica_id}A (auto-generated)
