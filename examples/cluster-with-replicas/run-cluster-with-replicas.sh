#!/bin/bash
# Marmot v2.9.12-beta - 2-Node Cluster with Read-Only Replicas
#
# Topology:
...
echo "=== Marmot v2.9.12-beta Cluster with Replicas ==="
...
generate_node_config() {
    ...
    cat > "$config_file" << EOF
# Marmot v2.9.12-beta - Node ${node_id} (auto-generated)
node_id = ${node_id}
...
generate_replica_config() {
    ...
    cat > "$config_file" << EOF
# Marmot v2.9.12-beta - Replica ${replica_id}A (auto-generated)
