#!/bin/bash
# Marmot v2.9.0-beta - 2-Node Cluster with Read-Only Replicas
#
# Topology:
...
echo "=== Marmot v2.9.0-beta Cluster with Replicas ==="
...
generate_replica_config() {
    ...
    cat > "$config_file" << EOF
# Marmot v2.9.0-beta - Replica ${replica_id}A (auto-generated)
