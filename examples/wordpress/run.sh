...
print_banner() {
    echo ""
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║${NC}     ${BOLD}Marmot v2.9.0-beta + WordPress Demo${NC}                             ${CYAN}║${NC}"
...
print_success() {
    ...
    echo -e "  ${CYAN}Marmot v2.9.0-beta${NC}  - Distributed SQLite with MySQL protocol"
    ...
    echo -e "  ┌─────────────┐    ┌──────────────────┐"
    echo -e "  │  WordPress  │───>│  Marmot v2.9.0-beta     │"
