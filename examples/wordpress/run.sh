...
print_banner() {
    echo ""
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║${NC}     ${BOLD}Marmot v2.9.12-beta + WordPress Demo${NC}                             ${CYAN}║${NC}"
...
start_stack() {
    ...
    echo -e "${YELLOW}[2/4]${NC} Building Marmot v2.9.12-beta image (this may take a few minutes on first run)..."
...
print_success() {
    ...
    echo -e "  ${CYAN}Marmot v2.9.12-beta${NC}  - Distributed SQLite with MySQL protocol"
    ...
    echo -e "  ┌─────────────┐    ┌──────────────────┐"
    echo -e "  │  WordPress  │───>│  Marmot v2.9.12-beta     │"
