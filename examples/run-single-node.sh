#!/bin/bash
# Marmot v2.9.12-beta - Single Node Example
...
echo "=== Marmot v2.9.12-beta Single Node ==="
echo ""
...
# Marmot v2.9.12-beta - Single Node Configuration (Optimized for Benchmarks)
...
strict_prepare_sync = false  # true waits for CDC segment fsync before PREPARE ACK
